...
<p class="form-label">
	{#if label}
		<label class="label flex items-center  text-sm sm:text-base dark:text-slate-400 text-slate-500" for>{label}  {#if tooltip}
